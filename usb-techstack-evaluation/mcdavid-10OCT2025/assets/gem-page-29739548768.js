    ...
    jQuery(function() {
        var $module = jQuery('#m-1564705104150').children('.module');
        ...
        setTimeout(function() {
            ...
            videoWrapper.empty().append('<div id="vimeo-wrapper-1564705104150"></div>');
            ...
            var player = new Vimeo.Player("vimeo-wrapper-1564705104150", options);
        ...
        jQuery(function() {
            var $module = jQuery('#m-1629240997318').children('.module');
            $module.gfV3Product();
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1629240997318-0').children('.module');
            var effect = $module.attr('data-effect');
            $module.gfV3ProductImage({
                'effect': effect
            })
        ...
        jQuery(function() {
            var $module = jQuery('#m-1629240997318-1').children('.module');
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1629240997325').children('.module');
            $module.gfV3ProductCartButton({ onItemAdded: function() {}});
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1629240997242').children('.module');
            $module.gfV3Product();
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1629240997242-0').children('.module');
            var effect = $module.attr('data-effect');
            $module.gfV3ProductImage({
                'effect': effect
            })
        ...
        jQuery(function() {
            var $module = jQuery('#m-1629240997242-1').children('.module');
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1629240997283').children('.module');
            $module.gfV3ProductCartButton({ onItemAdded: function() {}});
        }); 
    
        jQuery(function() {
            try {
                var $module = jQuery('#m-1629240997295').children('.module');   
                var navspeed = $module.data('navspeed'),
                    autoplaytimeout = $module.data('autoplaytimeout'),
                    autoplayhoverpause = $module.data('autoplayhoverpause'),
                    navlg = $module.data('navlg'),
        ...
        jQuery(function() {
            var $module = jQuery('#m-1629240704909').children('.module');
            $module.gfV3Product();
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1629240704909-0').children('.module');
            var effect = $module.attr('data-effect');
            $module.gfV3ProductImage({
                'effect': effect
            })
        ...
        jQuery(function() {
            var $module = jQuery('#m-1629240704909-1').children('.module');
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1629240704932').children('.module');
            $module.gfV3Product();
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1629240704932-0').children('.module');
            var effect = $module.attr('data-effect');
            $module.gfV3ProductImage({
                'effect': effect
            })
        ...
        jQuery(function() {
            var $module = jQuery('#m-1629240704932-1').children('.module');
        }); 
    
        jQuery(function() {
            try {
                var $module = jQuery('#m-1629240704913').children('.module');   
                var navspeed = $module.data('navspeed'),
                    autoplaytimeout = $module.data('autoplaytimeout'),
                    autoplayhoverpause = $module.data('autoplayhoverpause'),
                    navlg = $module.data('navlg'),
