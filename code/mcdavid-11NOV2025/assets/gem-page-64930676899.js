          ...
          jQuery(function () {
  var $hero = jQuery('#m-1597328878621');
  var $module = jQuery('#m-1597328878621').children('.module');
  ...
  if ($module.attr('data-fixedMode') == '1') {
    ...
    $module.parent().removeClass('gf_hero-fixed-mode');
          ...
          jQuery(function () {
  var $hero = jQuery('#m-1597257306722');
  var $module = jQuery('#m-1597257306722').children('.module');
  ...
  if ($module.attr('data-fixedMode') == '1') {
    ...
    $module.parent().removeClass('gf_hero-fixed-mode');
          ...
          jQuery(function () {
  var $hero = jQuery('#m-1597328005429');
  var $module = jQuery('#m-1597328005429').children('.module');
  ...
  if ($module.attr('data-fixedMode') == '1') {
    ...
    $module.parent().removeClass('gf_hero-fixed-mode');
          ...
          jQuery(function () {
  var $hero = jQuery('#m-1597328017530');
  var $module = jQuery('#m-1597328017530').children('.module');
