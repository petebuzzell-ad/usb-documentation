          ...
          jQuery(function () {
  var $hero = jQuery('#m-1597430866815');
  var $module = jQuery('#m-1597430866815').children('.module');
  ...
  if ($module.attr('data-fixedMode') == '1') {
    ...
    $module.parent().removeClass('gf_hero-fixed-mode');
          ...
          jQuery(function () {
  var $hero = jQuery('#m-1597430866837');
  var $module = jQuery('#m-1597430866837').children('.module');
  ...
  if ($module.attr('data-fixedMode') == '1') {
    ...
    $module.parent().removeClass('gf_hero-fixed-mode');
          ...
          jQuery(function () {
  var $hero = jQuery('#m-1597430866746');
  var $module = jQuery('#m-1597430866746').children('.module');
  ...
  if ($module.attr('data-fixedMode') == '1') {
    ...
    $module.parent().removeClass('gf_hero-fixed-mode');
          ...
          jQuery(function () {
  var $hero = jQuery('#m-1597430866754');
  var $module = jQuery('#m-1597430866754').children('.module');
  ...
  if ($module.attr('data-fixedMode') == '1') {
    ...
    $module.parent().removeClass('gf_hero-fixed-mode');
          ...
          jQuery(function () {
  var $hero = jQuery('#m-1602184329624');
  var $module = jQuery('#m-1602184329624').children('.module');
