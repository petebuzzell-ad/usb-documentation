...
def convert_file(md_file, output_dir):
    ...
    # Generate HTML page (paths are relative to root since files will be in root)
...
<body>
    ...
    # Write output file to root directory
...
def main():
    ...
    output_dir = root_dir  # Output to root for GitHub Pages
    ...
    print(f"\n✓ Successfully converted {len(md_files)} files to HTML in root directory")
